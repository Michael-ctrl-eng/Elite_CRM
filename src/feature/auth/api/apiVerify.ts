...
export async function POST(req: Request) {
  try {
    ...
    action === 'verify' ? await sendEmail({
      to: email,
      subject: "Activate your Elite CRM account",
